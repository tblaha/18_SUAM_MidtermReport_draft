...
\begin{enumerate}
    ...
    \item The manufacturing process and materials needed for the system is not sustainable
...
For several of these there are things that can be done to mitigate these risks. Examples are are as follows. For 1, make a conservative first guess of the MTOW. For 3, change the target group or scale the system. For 5, invest in autonomous flying development.  For 6, Promote UAM safety awareness through advertisements and demonstrations. For10, adjust the route networks in such a way that airspace needed does not interfere with flightpaths and for 11  
