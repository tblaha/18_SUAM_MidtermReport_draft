...
\multirow{3}{*}{\rotatebox[origin=c]{90}{{\textbf{Fixed}}}}  
                       ...
                       &    prop.unit.propunit.axialvel     &    m/s    &   Rotor axial velocity  \\ \cline{2-4}
                       &    prop.unit.rotor(1).solidity     &    -    &   Rotor blade solidity  \\ \cline{2-4}
                       &    prop.unit.rotor(1).kappa     &    -    &   single rotor induced power factor (Leishman)  \\ \cline{2-4}
                       &    prop.unit.rotor(1).blades.cl\_alpha     &    /\degree    &   Lift curve slope  \\ \cline{2-4}
                       &    prop.unit.rotor(1).blades.Cd0     &    -    &   Rotor blade profile drag  \\ \cline{2-4}
                       &    prop.unit.rotor(1).blades.D1     &    -    &   Quadratic coefficient drag curve  \\ \cline{2-4}
                       &    prop.unit.rotor(1).blades.D2     &   -    &   Linear coefficient drag curve  \\ \cline{2-4}
                       &    prop.unit.rotor(1).blades.pitch\_deg     &    \degree    &   Rotor blade pitch  \\ \Xhline{2\arrayrulewidth}
\multirow{3}{*}{\rotatebox[origin=c]{90}{{\textbf{Variable}}}}  
                       ...
                       &    prop.unit.rotor(1).blades.num     &    -    &   Number of blades per rotor  \\ \cline{2-4}
                       &    prop.unit.rotor(1).radius     &    m    &   Rotor radius  \\ \cline{2-4}
                       &    prop.unit.rotor(1).omega     &    rad/s    &   Rotor radial velocity  \\ \Xhline{2\arrayrulewidth}
\end{tabular}
\end{table}
